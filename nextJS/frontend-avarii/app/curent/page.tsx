...
export default function CurentPage() {
  ...
  const accidentaleVizibile = arataAccidentale ? accidentale : accidentale.slice(0, 8);
                  ...
                  {programate.length > 0 && (
                    <section className="flex flex-col gap-3">
                      ...
                      <label className="flex flex-col gap-1">
                        <span className="text-xs font-semibold text-slate-600">Alege județul:</span>
                        <select
                          value={judetSelectat}
                  ...
                  {accidentale.length > 0 && (
                    <section className="flex flex-col gap-3">
                      ...
                      {accidentale.length > 8 && (
                        ...
                        >
                          {arataAccidentale ? "Arată mai puține" : `Arată mai multe (${accidentale.length - 8})`}
                        </button>
                      )}
                    </section>
                  )}
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-4">
            <div className="flex flex-col bg-white rounded-3xl shadow-sm border border-slate-200 isolate">
                ...
                <div className="relative w-full flex-1 min-h-[500px] rounded-b-3xl overflow-hidden">
                  <MapComponent avarii={accidentale} />
                </div>
            </div>
            <p className="text-xs text-slate-500 leading-relaxed px-1">
              💡 Deconectările programate sunt afișate în lista din stânga, pe județe —
